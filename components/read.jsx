...
import { collection, addDoc, getDocs, orderBy, query, doc, deleteDoc, updateDoc, getDoc} from 'firebase/firestore';
...
export default function Read() {
  ...
  //função delete
  const deleteBtn = (id)=>{
    let documento = doc(database,"contato",id)
    deleteDoc(documento)
    .then(()=>{
      read()
    })
          ...
          return(
            <div className='card'>
              ...
              <div className="input-group">
                <input type="button" onClick={()=>show(lista.id)} className='btn-outline-warning form-control' value="Alterar" />
